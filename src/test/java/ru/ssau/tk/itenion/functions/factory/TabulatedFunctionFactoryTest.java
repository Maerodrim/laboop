...
import ru.ssau.tk.itenion.functions.tabulatedFunctions.*;
...
public class TabulatedFunctionFactoryTest {
    ...
    public void testCreateStrict() {
        ...
        Assert.assertEquals(list.apply(2.), 4);
        ...
        Assert.assertEquals(list.iterator().next().x, 1);
        list.setY(1, 0);
    ...
    public void testCreateStrictUnmodifiable() {
        ...
        Assert.assertEquals(func.apply(2.), 4);
        ...
        Assert.assertEquals(func.iterator().next().x, 1);
    ...
    public void testCreateUnmodifiable() {
        ...
        assertEquals(array.rightBound(), 5);
        Assert.assertEquals(array.iterator().next().x, 1);
        Assert.assertEquals(array.apply(2.5), 5);
        ...
        assertEquals(list.rightBound(), 5);
        Assert.assertEquals(list.iterator().next().x, 1);
        Assert.assertEquals(list.apply(2.5), 5);
